            ...
            <form action="{{route('add-car')}}" class="signin-form" method="post" enctype="multipart/form-data">
                ...
                <div class=" d-flex mb-3">
                    <div class="form-group col-md-6">
                        <label class="label" for="type_car">Tipe Mobil</label>
                        <input type="text" class="form-control  @error('type_car') is-invalid @enderror" name="type_car" placeholder="Tipe Mobil" required autocomplete="type_car">
                        @error('type_car')
                ...
                <div class="form-group mb-3 col-md-12">
                    ...
                    <input type="number" name="status" class="form-control @error('status') is-invalid @enderror" placeholder="Status" required autocomplete="status">
                    @error('status')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
        ...
        <table class="table table-primary table-striped col-md-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="{{route("/Image/$car->photo")}}" alt="foto mahasiswa" class="foto" style=" width: 80px; height: 110px" onerror="this.src='/Image/profile-default.jpg'"></td>
                    <td>{{ $car->car_type}}</td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{route('edit-car',['id'=>$car->id])}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class=" d-flex mb-3">
                                            <div class="form-group col-md-6">
                                                <label class="label" for="type_car1">Tipe Mobil</label>
                                                <input type="text" class="form-control  @error('type_car1') is-invalid @enderror" name="type_car1" placeholder="Tipe Mobil" required autocomplete="type_car1">
                                                @error('type_car1')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
